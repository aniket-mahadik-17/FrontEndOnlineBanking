...
import { getAccountDetailsList, onAccountDeleteClickHandler } from "../Services/AccountDetails.service";
            ...
            <tbody>
               {accountDetailsList.map((accountdetails)=>{
                ...
                <tr key={accountdetails.accountNumber}>
                    ...
                    <td><button onClick={()=>{onAccountDeleteClickHandler(accountdetails.accountNumber)}} className="btn btn-danger">Delete</button></td>
